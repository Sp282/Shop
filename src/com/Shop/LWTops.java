...
public class LWTops extends Tops{
	LWTops() {
		super("Blue", "Large",500);
		// TODO Auto-generated constructor stub
	}
static Tops sw=new SWTops();
static int q=15;
//String size="small";
		   ...
		   try {
			...
			if(options.equalsIgnoreCase("1"))
			{
				...
				if(Quantity.confirmQ(s))
				{
					...
					q-=sw.quantity;
					Bill.arr.add(new Bill("Large Tops",sw.price,sw.quantity));
					break;
					}
