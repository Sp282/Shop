...
public class MWJeans extends Jeans {

	MWJeans() {
		super("Deep blue", "Medium", 1000);
	}
static Jeans mw=new MWJeans();
static int q=5;
		 ...
		 System.out.println("Would you like to purchase?\n press 1 for yes and 2 for No");
		   ...
		   try {
			...
			if(options.equalsIgnoreCase("1"))
			{
				...
				{
					Tester.c1.price+=(mw.price*mw.quantity);
					System.out.println("price into q "+(mw.price*mw.quantity)+" and T price "+Tester.c1.price);
					q-=mw.quantity;
					Bill.arr.add(new Bill("Medium Jeans",mw.price,mw.quantity));
					break;
					}
