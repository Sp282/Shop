...
public class MenSWJeans extends MJeans {
	
	
	MenSWJeans() {
		super("Blue", "Small", 1000);
		// TODO Auto-generated constructor stub
	}
static MJeans ms=new MenSWJeans();
static int q=10;
	 ...
	 System.out.println("Would you like to purchase?\n press 1 for yes and 2 for No");
	   ...
	   try {
		...
		if(options.equalsIgnoreCase("1"))
		{
			...
			{
				Tester.c1.price+=(ms.price*ms.quantity);
				System.out.println("price into q "+(ms.price*ms.quantity)+" and T price "+Tester.c1.price);
				q-=ms.quantity;
				Bill.arr.add(new Bill("Small Jeans",ms.price,ms.quantity));
				break;
				}
